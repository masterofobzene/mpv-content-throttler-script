...
Now _lets say_ that out of __20 subfolders__ of different themes, __5 are MASSIVE__ and have MUCH MORE media than the other 15 regular ones. You play the MEDIA folder playlist (in shuffle mode) and you get 90% the content of the 5 biggest sized subfolders, because there is too much of that content that it occludes all the rest, the 15 other folders containing other themed media are rarely played.
...
Sorry for the long text but there is no other way of explaining this specific script.
